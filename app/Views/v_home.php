		        ...
		        <div class="col-lg-6">
		            ...
		            <div class="card">
		                <div class="card-body">
		                    ...
		                    <h5 class="card-title"><?php echo $produk['nama'] ?><br><?php echo number_to_currency($produk['hrg'], 'IDR') ?><br><br>Stok : <?php echo $produk['jml'] ?></h5>
		                    <button type="submit" class="btn btn-dark bi"><i class="bi bi-cart-check"></i>Beli</button>
		                </div>
		            </div>
		            <?= form_close() ?>
		        </div>
