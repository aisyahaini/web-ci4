<?php
		...
		class TransaksiController extends BaseController
		{
			...
			private $apiKey = "a45cc387840708aa62ecfd7d7f649b5b";
			...
			public function history()
			{
				...
				$transaksiModel = new \App\Models\TransaksiModel(); 
				$transaksiDetailModel = new \App\Models\TransaksiDetailModel();
				$data['datas'] = $transaksiModel->where('username', session()->get('username'))->findAll();
				$data['datasDetail'] = $transaksiDetailModel->join('barang', 'transaksi_detail.id_barang = barang.id', 'left')->where('created_by', session()->get('username'))->findAll();
			...
			{
				$transaksiModel = new \App\Models\TransaksiModel();
				$data['datas'] = $transaksiModel->findAll();
			...
			public function edit_status($id)
			{
				...
				$transaksiModel->set('status', $status)->where('id', $id)->update();
